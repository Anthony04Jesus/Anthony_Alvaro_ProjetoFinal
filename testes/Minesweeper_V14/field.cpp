...
{
    //QString mensagem = QString("Parabéns, você venceu!!!\nCliques:\n-Esquerdo: %1 cliques\n-Direito: %2 cliques").arg(esquerdo).arg(direito);
    // QString resultTempo = QString("Tempo necessário: %1 segundos").arg(tempo);
    QString cliques = QString("Botão esquerdo: ");
    // QString cliquesDir = QString("Botão direito: %1").arg(direito);

    ResultWindow *dialog = new ResultWindow(cliques);
